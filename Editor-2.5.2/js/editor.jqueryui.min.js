 ...
 */
(e=>{var o,i;"function"==typeof define&&define.amd?define(["jquery","datatables.net-jqui","datatables.net-editor"],function(t){return e(t,window,document)}):"object"==typeof exports?(o=require("jquery"),i=function(t,n){n.fn.dataTable||require("datatables.net-jqui")(t,n),n.fn.dataTable.Editor||require("datatables.net-editor")(t,n)},"undefined"==typeof window?module.exports=function(t,n){return t=t||window,n=n||o(t),i(t,n),e(n,0,t.document)}:(i(window,o),module.exports=e(o,window,window.document))):e(jQuery,window,document)})(function(o,t,n){var i,e=o.fn.dataTable,d=!1,a=(e.Editor.defaults.display="jqueryui","btn ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only");return o.extend(!0,e.Editor.classes,{form:{button:a,buttonInternal:a,buttonSubmit:a}}),e.Editor.display.jqueryui=o.extend(!0,{},e.Editor.models.displayController,{init:function(){return i||((i=o('<div class="DTED"></div>').css("display","none").appendTo("body").dialog(o.extend(!0,e.Editor.display.jqueryui.modalOptions,{autoOpen:!1,buttons:{A:function(){}},closeOnEscape:!1}))).data("uiDialog")._focusTabbable=function(){}),e.Editor.display.jqueryui},open:function(t,n,e){i.children().detach(),i.append(n).dialog("open"),o(t.dom.formError).appendTo(i.parent().find("div.ui-dialog-buttonpane")),i.parent().find(".ui-dialog-title").html(t.dom.header.innerHTML),i.parent().addClass("DTED");n=o(t.dom.buttons).children().addClass("ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only").each(function(){o(this).wrapInner('<span class="ui-button-text"></span>')});i.parent().find("div.ui-dialog-buttonset").children().detach(),i.parent().find("div.ui-dialog-buttonset").append(n.parent()),i.parent().find("button.ui-dialog-titlebar-close").off("click").on("click",function(){d||t.close("icon")}),o(i).off("dialogclose.dte-ju").on("dialogclose.dte-ju",function(){d||t.close()}),e&&e()},close:function(t,n){i&&(d=!0,i.dialog("close"),d=!1),n&&n()},node:function(){return i.parent()[0]}}),e.Editor.display.jqueryui.modalOptions={width:600,modal:!0},e.Editor});